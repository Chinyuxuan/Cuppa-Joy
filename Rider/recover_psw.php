...
if(isset($_POST["email"])){
    ...
    if(mysqli_num_rows($sql) <= 0){
        ...
        <a href='localhost/fyp/Rider/reset_psw.php?token=$token&email=$email'>Reset Password</a>
        <br><br>
        <p>With regards,</p>
        <b>Cuppa Joy Team</b>";
...
<meta charset="utf-8">
  ...
  <title>Rider Recover Password - Cuppa Joy</title>
</head>
<body>
<main>
    <div class="container">
  ...
  <script>
    function validateEmail() {
      var email = document.getElementById("yourUsername");
