...
<body>
							...
							<ul>
								...
								<li>
									...
									<?php
										...
										if(isset($_SESSION["customer_id"])) {
											// User is logged in, display logout button
											echo '<a class="shopping-cart logout" href="logout.php" onclick="return confirmLogout();"><i class="fas fa-sign-out-alt"></i> Log Out</a>';
										} else {
											// User is not logged in, do nothing or display alternative content
										}
	...
	<div class="container">
    	<div class="main-body">
              ...
              <div class="card mb-3">
					<div class="card-body">
						<div class="row">
							...
							<span id="firstname"><?php echo $firstname; ?></span>  <span id="lastname"><?php echo $lastname; ?></span>
							</div>
                  		</div>
						<hr>
						<div class="row">
						...
						<div class="row">
							...
							<div class="col-sm-9 text-secondary">
							<span id="contno"><?php echo $phno; ?></span>
							</div>
						</div>
						<!--
						<hr>
			...
			<div class="col-md-8">
				<div class="container-address mb-3 card-body">
					<div class="col-sm-3">
					...
					<?php
							...
							<div class="card-body">
								<div class="row">
									<div class="col-sm-9 text-secondary">
									<span><?php echo $row['Address_1']; ?>,<?php echo $row['Address_2']; ?>,
									<?php echo $row['Postcode']; ?> <?php echo $row['City']; ?> <?php echo $row['state_country']; ?></span>
						...
						<?php
							...
							?>
							<hr>
							<input type="submit" id="saveMorebtn" value="Add address" onclick="openAddPopup()">
				</div>
    ...
    <section id="editprofile">
		...
		<div>
			...
			<input type="text" id="editFName" name="editFName" placeholder="<?php echo $firstname; ?>" oninput="validateFirstName()" >
		</div>
		<span id="name-error-first" class="error-message"></span>

		<div>
			<label for="editLName">Last Name:</label>
			<input type="text" id="editLName" name="editLName" placeholder="<?php echo $lastname; ?>" oninput="validateLastName()" required>
		</div>
